...
export function CreateAdModal() {
 ...
 async   function handleCreateAd(event: FormEvent) {
      ...
      try { await axios.post(`http://localhost:3333/games/${data.game}/ads`, {
        ...
        alert('The ad has been published!')
            ...
            <Dialog.Title className='text-3xl font-black'>Publish an ad</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                <div className='flex flex-col gap-2'>
                  ...
                  <option disabled value="">Select game you wish to play</option>
                  {games.map(game => {
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Input name="name" id='name' placeholder='How you wish to be called?'/>
                </div>

                <div className='grid grid-cols-2 gap-6'>
                  <div className='flex flex-col gap-2'>
                    <label htmlFor='yearsPlaying'>Since when?</label>
                    <Input name="yearsPlaying" id='yearsPlaying' type='number' placeholder="# of years played" />
                  </div>
                  <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-6'>
                  <div className='flex flex-col gap-2'>
                    <label htmlFor='weekDays'>When are you used to play?</label>
                    <ToggleGroup.Root 
                    type="multiple" 
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    <label htmlFor='hoursStart'>Which time of day?</label>
